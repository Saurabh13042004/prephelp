            ...
            <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white">
                    ...
                    <p className="text-indigo-100 max-w-2xl">
                        Ready to ace your next interview? You've completed 75% of your weekly goals.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {stats.map((stat) => {
                        ...
                        return (
                            <div key={stat.label} className="bg-white rounded-xl shadow-sm p-6 transition-transform hover:scale-105">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            {upcomingInterviews.map((interview) => (
                                <div key={`${interview.company}-${interview.date}`} className="flex items-center p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600">{interview.type} • {interview.date}</p>
                                    </div>
                                    <Link
                                        to="/mock-interview"
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            {recentExperiences.map((experience) => (
                                <div key={`${experience.company}-${experience.date}`} className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-600">
                            Access a curated list of interview questions and prepare effectively.
                        </p>
                    </Link>
                </div>
            </div>
